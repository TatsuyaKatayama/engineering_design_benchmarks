...
from .evaluation import REQUIRED_TOOLS
...
PUBLIC_MCP_TOOL_NAMES = tuple(sorted(REQUIRED_TOOLS))
...
if set(TOOL_DEFINITIONS) != set(PUBLIC_MCP_TOOL_NAMES):
    raise RuntimeError("public MCP tool definitions do not match evaluator tool names")
if set(TOOL_HANDLERS) != set(PUBLIC_MCP_TOOL_NAMES):
    raise RuntimeError("public MCP tool handlers do not match evaluator tool names")
